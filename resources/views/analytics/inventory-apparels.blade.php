...
@section('content')        
    ...
    <div class = "content dashboard">
        <div class = "container-fluid">
                                        ...
                                        @foreach ($apparels as $apparel)
                                            @if ($apparel->type === "shirt")
                                                <tr onclick = "popModal(
                                                               ...
                                                               {{ $apparel->price }},
                                                               '{{ $apparel->type }}',
                                                               {{ $apparel->stock_universal }},
                                                               [{{ $apparel->stock_xs }}, {{ $apparel->stock_sm }}, {{ $apparel->stock_md }}, {{ $apparel->stock_lg }}, {{ $apparel->stock_xl }}],
                                                               '{{ $apparel->sold }}')"
                                                        data-toggle = "modal"
                                                        data-target = "#apparelModal">
                                                    <td>{{ $apparel->name }}</td>
            ...
            <!-- Scripts -->
            <script>
                function popModal (id, name, imgUrl, price, type, stockUniversal, stocks, sold) {
                    ...
                    //Accessory details
                        ...
                        else if (stockUniversal >= {{ $minmax['mid'] }} && stockUniversal <= {{ $minmax['opt'] }}) {}
                        else if (stockUniversal >= {{ $minmax['low'] }} && stockUniversal <= {{ $minmax['mid'] }}) {
                            list.className = `orange`;
