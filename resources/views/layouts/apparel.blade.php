...
@section('content')
        ...
        <div class = "container">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class = "text-left">
                                                ...
                                                <input id = "" type = "number" class = "form-control" value = "1"/>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
            ...
            <div id = "button-container" class = "properties row">
                <div class = "col">
                    <hr/>
                    <div class = "buttons">
                        <button onclick = "window.alert('Dummy button clicked!')" type = "button" class = "btn btn-lg btn-primary">
                            <i class = "material-icons">add_shopping_cart</i> Add To Cart
                        </button>
                        <div class = "padding"></div>
                        <button type = "button" class = "btn btn-lg btn-primary" data-toggle = "modal" data-target = "#purchaseModal">
    ...
    <div class = "modal fade" id = "purchaseModal">
        <div class = "modal-dialog">
            <div class = "modal-content">
                <div class = "modal-header">
                    <h4 class = "modal-title">Product Transaction</h4>
                    <button type = "button" class = "close" data-dismiss = "modal" aria-label = "Close">
                        <i class = "material-icons">clear</i>
                    </button>
                </div>
